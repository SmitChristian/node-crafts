async function showCrafts() {
    let response = await fetch("http://node-crafts-14.onrender.com/api/crafts");
    ...
    craftJSON.forEach((craft) => {
        ...
        img.src = "http://node-crafts-14.onrender.com/images/" + craft.image;
        console.log(img.src);
        ...
        modalImg.src = "http://node-crafts-14.onrender.com/images/" + craft.image;
